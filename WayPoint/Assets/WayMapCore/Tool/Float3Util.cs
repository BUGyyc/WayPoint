...
public static class VectorUtil
{
    ...
    // public static PopsicleList<Float3> ToFloat3List(this List<Vector3> srcList)
    // {
    //     PopsicleList<Float3> result = new PopsicleList<Float3>();

    //     for (int i = 0; i < srcList.Count; i++)
    //     {
    //         result.Add(srcList[i].ToFloat3());
    //     }
